...
void I2C_Init(void)
{
    ...
    I2C1->DIV = (uint32_t)((((SystemCoreClock/2) * 10U) / (100000 * 4U) + 5U) / 10U - 1U); /* Compute proper divider for I2C clock */;
    I2C1->CON |= I2C_CON_IPEN_Msk;
    /* Set I2C1 ADDR0 Slave Addresses */
    I2C1->SADDR0  = (I2C_ADDR << 1U) | I2C_GCMODE_DISABLE;
    I2C1->CON |= I2C_CON_INTEN_Msk;
...
void I2C1_IRQHandler(void)
{
    ...
    if (I2C_GET_TIMEOUT_FLAG(I2C1))
    {
        ...
        I2C1->INTSTS |= I2C_INTSTS_TIF_Msk;
    }
    else
    {
