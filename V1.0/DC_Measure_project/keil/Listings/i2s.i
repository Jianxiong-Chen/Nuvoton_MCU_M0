...
#line 14 "..\\..\\Library\\StdDriver\\src\\i2s.c"
...
#line 15 "..\\..\\Library\\StdDriver\\src\\i2s.c"
...
static uint32_t I2S_GetSourceClockFreq(I2S_T *i2s)
{
    ...
    u32ClkSrcSel = ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (0x3ul << (16));
...
uint32_t I2S_Open(I2S_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Channels, uint32_t u32DataFormat, uint32_t u32AudioInterface)
{
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 |= (0x1ul << (29));
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 &= ~(0x1ul << (29));

    i2s->CTRL = u32MasterSlave | u32WordWidth | u32Channels | u32DataFormat | u32AudioInterface | (4 << (9)) | (3 << (12));

    u32SrcClk = I2S_GetSourceClockFreq(i2s);

    u32BitRate = u32SampleRate * (((u32WordWidth>>4) & 0x3) + 1) * 16;
    u8Divider = ((u32SrcClk/u32BitRate) >> 1) - 1;
    i2s->CLKDIV = (i2s->CLKDIV & ~(0xfful << (8))) | (u8Divider << 8);
...
uint32_t I2S_EnableMCLK(I2S_T *i2s, uint32_t u32BusClock)
{
    ...
    i2s->CLKDIV = (i2s->CLKDIV & ~(0x7ul << (0))) | u8Divider;

    i2s->CTRL |= (0x1ul << (15));

    u32Reg = i2s->CLKDIV & (0x7ul << (0));
...
void I2S_SetFIFO(I2S_T *i2s, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
    i2s->CTRL = (i2s->CTRL & ~((0x7ul << (9)) | (0x7ul << (12))) |
                 (u32TxThreshold << (9)) |
                 (u32RxThreshold << (12)));
}
