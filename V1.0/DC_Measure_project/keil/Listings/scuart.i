...
#line 13 "..\\..\\Library\\StdDriver\\src\\scuart.c"
...
{
    uint32_t u32ClkSrc = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (0x3ul << (18))) >> (18);
    uint32_t u32Clk;
    ...
    if(sc == ((SC_T *) (((uint32_t)0x40100000) + 0x90000)))
        u32Clk /= ((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0 & (0xful << (28))) >> (28)) + 1;
    else if(sc == ((SC_T *) (((uint32_t)0x40100000) + 0xB0000)))
        u32Clk /= (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV1 & (0xful << (0))) + 1;
    else 
        u32Clk /= ((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV1 & (0xful << (4))) >> (4)) + 1;
...
uint32_t SCUART_SetLineConfig(SC_T* sc, uint32_t u32Baudrate, uint32_t u32DataWidth, uint32_t u32Parity, uint32_t  u32StopBits)
{
    ...
    sc->UACTL = u32Parity | u32DataWidth | (0x1ul << (0));  
