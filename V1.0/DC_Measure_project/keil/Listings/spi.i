...
void SPI_Close(SPI_T *spi)
{
    ...
    {
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 |= (0x1ul << (12));
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 &= ~(0x1ul << (12));
    }
    else if(spi == ((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))
    {
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 |= (0x1ul << (13));
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 &= ~(0x1ul << (13));
    }
    else
    {
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 |= (0x1ul << (14));
        ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 &= ~(0x1ul << (14));
    }
}
...
void SPI_EnableAutoSS(SPI_T *spi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    spi->SSR = (spi->SSR & ~((0x1ul << (2)) | (0x3ul << (0)))) | (u32SSPinMask | u32ActiveLevel) | (0x1ul << (3));
}
...
uint32_t SPI_SetBusClock(SPI_T *spi, uint32_t u32BusClock)
{
    ...
    if(spi == ((SPI_T *) (((uint32_t)0x40000000) + 0x30000)))
    {
        if((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (0x1ul << (20))) == (0x1UL<<(20)))
    ...
    {
        if((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (0x1ul << (21))) == (0x1UL<<(21)))
            u32ClkSrc = CLK_GetHCLKFreq();
        else
            u32ClkSrc = CLK_GetPLLClockFreq();
    }
    ...
    {
        if((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL2 & (0x1ul << (22))) == (0x1UL<<(22)))
            u32ClkSrc = CLK_GetHCLKFreq();
        else
            u32ClkSrc = CLK_GetPLLClockFreq();
    }
...
void SPI_EnableFIFO(SPI_T *spi, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
    spi->FFCTL = (spi->FFCTL & ~((0x7ul << (28)) | (0x7ul << (24))) |
                  (u32TxThreshold << (28)) |
                  (u32RxThreshold << (24)));
