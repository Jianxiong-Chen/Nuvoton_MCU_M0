...
void PDMA_Open(uint32_t u32Mask)
{
    ((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->GCRCSR |= (u32Mask << 8);
}
...
void PDMA_Close(void)
{
    ((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->GCRCSR = 0;
}
...
{
    PDMA_T *pdma;
    pdma = (PDMA_T *)((uint32_t) (((uint32_t)0x50000000) + 0x08100) + (0x100 * (u32Ch-1)));
    pdma->CSR = (pdma->CSR & ~(0x3ul << (19))) | u32Width;
    switch (u32Width)
    {
    case 0x00000000UL:
...
void PDMA_SetTransferAddr(uint32_t u32Ch, uint32_t u32SrcAddr, uint32_t u32SrcCtrl, uint32_t u32DstAddr, uint32_t u32DstCtrl)
{
    ...
    pdma->SAR = u32SrcAddr;
    pdma->DAR = u32DstAddr;
    pdma->CSR = (pdma->CSR & ~((0x3ul << (4))|(0x3ul << (6)))) | (u32SrcCtrl | u32DstCtrl);
}
...
void PDMA_SetTransferMode(uint32_t u32Ch, uint32_t u32Peripheral, uint32_t u32ScatterEn, uint32_t u32DescAddr)
{
    ...
    {
    case 1:
        ((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR0 = (((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR0 & ~(0x1ful << (8))) | (u32Peripheral << (8));
        break;
    case 2:
        ((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR0 = (((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR0 & ~(0x1ful << (16))) | (u32Peripheral << (16));
        break;
    case 3:
        ((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR0 = (((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR0 & ~(0x1ful << (24))) | (u32Peripheral << (24));
        break;
    case 4:
        ((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR1 = (((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->DSSR1 & ~(0x1ful << (0))) | u32Peripheral;
        break;
    default:
        ;
    }
    if (u32Peripheral == 0x0000001FUL)
        pdma->CSR &= ~(0x3ul << (2));
    else if (u32Peripheral & 0x10)
        pdma->CSR = (pdma->CSR & ~(0x3ul << (2))) | 0x4;  
    else
        pdma->CSR = (pdma->CSR & ~(0x3ul << (2))) | 0x8;  
}
...
void PDMA_SetTimeOut(uint32_t u32Ch, uint32_t u32OnOff, uint32_t u32TimeOutCnt)
{
    ...
    pdma->TCR = (pdma->TCR & ~(0xfffful << (0))) | u32TimeOutCnt;
    pdma->CSR = (pdma->CSR & ~(0x1ul << (12))) | (u32OnOff << (12));
