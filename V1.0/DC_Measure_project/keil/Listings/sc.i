...
#line 13 "..\\..\\Library\\StdDriver\\src\\sc.c"



static uint32_t u32CardStateIgnore[3] = {0, 0, 0};
...
uint32_t SC_IsCardInserted(SC_T *sc)
{
    ...
    uint32_t cond1 = ((sc->PINCSR & (0x1ul << (4))) >> (4));
    uint32_t cond2 = ((sc->PINCSR & (0x1ul << (10))) >> (10));

    if(sc == ((SC_T *) (((uint32_t)0x40100000) + 0x90000)) && u32CardStateIgnore[0] == 1)
        return (1);
    else if(sc == ((SC_T *) (((uint32_t)0x40100000) + 0xB0000)) && u32CardStateIgnore[1] == 1)
        return (1);
    else if(sc == ((SC_T *) (((uint32_t)0x40100000) + 0xC0000)) && u32CardStateIgnore[2] == 1)
        return (1);
    else if(cond1 != cond2)
        return (0);
    else
...
void SC_Open(SC_T *sc, uint32_t u32CD, uint32_t u32PWR)
{
    ...
    if(sc == ((SC_T *) (((uint32_t)0x40100000) + 0x90000)))
        u32Intf = 0;
    else if(sc == ((SC_T *) (((uint32_t)0x40100000) + 0xB0000)))
        u32Intf = 1;
    else
        u32Intf = 2;
...
void SC_ResetReader(SC_T *sc)
{
    ...
    sc->PINCSR = (sc->PINCSR & ~(0x1ul << (0))) | (0x1ul << (7));
