...
#line 14 "..\\..\\Library\\StdDriver\\src\\ebi.c"
...
void EBI_Open(uint32_t u32Bank, uint32_t u32DataWidth, uint32_t u32TimingClass, uint32_t u32BusMode, uint32_t u32CSActiveLevel)
{
    ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON = 0;

    if (u32DataWidth == 8)
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON &= ~(0x1ul << (1));
    else
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (0x1ul << (1));

    ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON &= ~((0x7ul << (16)) | (0x7ul << (8)));
    switch (u32TimingClass)
    {
    case 0x0:
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (0 << (16));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (0 << (8));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EXTIME = 0;
        break;

    case 0x1:
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (1 << (16));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (1 << (8));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EXTIME = (4 << (0)) | (1 << (8)) |
                      (2 << (12)) | (2 << (16)) |
                      (2 << (24));
        break;

    case 0x2:
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (2 << (16));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (2 << (8));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EXTIME = (8 << (0)) | (2 << (8)) |
                      (4 << (12)) | (4 << (16)) |
                      (4 << (24));
        break;

    case 0x3:
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (3 << (16));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (3 << (8));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EXTIME = (16 << (0)) | (3 << (8)) |
                      (8 << (12)) | (8 << (16)) |
                      (8 << (24));
        break;

    case 0x4:
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (4 << (16));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (4 << (8));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EXTIME = (20 << (0)) | (4 << (8)) |
                      (12 << (12)) | (12 << (16)) |
                      (12 << (24));
        break;

    case 0x5:
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (5 << (16));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (5 << (8));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EXTIME = (26 << (0)) | (5 << (8)) |
                      (14 << (12)) | (14 << (16)) |
                      (14 << (24));
        break;

    case 0x6:
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (6 << (16));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (5 << (8));
        ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EXTIME = (31 << (0)) | (7 << (8)) |
                      (15 << (12)) | (15 << (16)) |
                      (15 << (24));
        break;
    }

    ((EBI_T *) (((uint32_t)0x50000000) + 0x10000))->EBICON |= (0x1ul << (11)) | (0x1ul << (0));
}
