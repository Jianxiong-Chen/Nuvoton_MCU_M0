...
void CRC_Open(uint32_t u32Mode, uint32_t u32Attribute, uint32_t u32Seed, uint32_t u32DataLen)
{
    ((DMA_GCR_T *) (((uint32_t)0x50000000) + 0x08F00))->GCRCSR |= (0x1ul << (24));
    ((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->SEED = u32Seed;
    ((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->CTL = u32Mode | u32Attribute | u32DataLen | (0x1ul << (0));
     
    ((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->CTL |= (0x1ul << (1));
}
...
void CRC_StartDMATransfer(uint32_t u32SrcAddr, uint32_t u32ByteCount)
{
    ((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->DMASAR = u32SrcAddr;
    ((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->DMABCR = u32ByteCount;
    ((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->CTL |= (0x1ul << (23));
}
...
uint32_t CRC_GetChecksum(void)
{
    switch (((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->CTL & (0x3ul << (30)))
    {
    case 0x00000000UL:
    case 0x80000000UL:
        return (((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->CHECKSUM & 0xffff);

    case 0xC0000000UL:
        return (((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->CHECKSUM);

    case 0x40000000UL:
        return (((DMA_CRC_T *) (((uint32_t)0x50000000) + 0x08E00))->CHECKSUM & 0xff);
