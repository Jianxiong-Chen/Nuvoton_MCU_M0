...
#line 14 "..\\..\\Library\\StdDriver\\src\\usbd.c"
...
#line 15 "..\\..\\Library\\StdDriver\\src\\usbd.c"
...
void USBD_Open(S_USBD_INFO_T *param, CLASS_REQ pfnClassReq, SET_INTERFACE_REQ pfnSetInterface)
{
    ...
    ((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->CTL = 0x29f;
    ((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->PDMA |= (0x1ul << (2));
     
    ((uint32_t)(((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->CTL |= (0x1ul << (4))));
}
...
void USBD_ProcessSetupPacket(void)
{
    ...
    default:   
    {
        ...
        (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EP[0]. CFG + (uint32_t)((0) << 4))) |= (0x1ul << (9)));
        (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EP[0]. CFG + (uint32_t)((1) << 4))) |= (0x1ul << (9)));
        break;
    }
    }
}
            ...
            if(g_usbd_SetupPacket[2] == 0x00)
            {
                ...
                for(i = 0; i < 8; i++)
                {
                    if(((((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EP[i].CFG & 0xF) == epNum) && ((g_u32EpStallLock & (1 << i)) == 0))
                        ((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EP[i].CFG &= ~((0x1ul << (9)) | (0x1ul << (7)));
                }
            }
...
void USBD_CtrlIn(void)
{
    ...
    else
    {
        ...
        {
            (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EP[0]. MXPLD + (uint32_t)((0) << 4))) = (0ul));
            g_usbd_CtrlInZeroFlag = (uint8_t)0ul;
        }
    }
}
...
void USBD_CtrlOut(void)
{
    ...
    if (g_usbd_CtrlOutToggle != (((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EPSTS & (0xful << (12))))
    {
        g_usbd_CtrlOutToggle = ((USBD_T *) (((uint32_t)0x40000000) + 0x60000))->EPSTS & (0xful << (12));
