...
#line 13 "..\\..\\Library\\StdDriver\\src\\dac.c"
...
void DAC_Open(DAC_T *dac, uint32_t u32Ch, uint32_t u32TrgSrc)
{
    ...
    if(u32Delay == 0)
        u32Delay++;
    if(u32Ch == 0)
        ((DAC_T *) (((uint32_t)0x40000000) + 0xA0000))->CTL0 = (u32Delay << (8)) | u32TrgSrc | (0x1ul << (0));
    else
        ((DAC_T *) (((uint32_t)0x40000000) + 0xA0000))->CTL1 = (u32Delay << (8)) | u32TrgSrc | (0x1ul << (0));

    
    u32Delay = CLK_GetHCLKFreq() * 2 / 1000000;
    if(u32Delay == 0)
        u32Delay++;
    ((DAC_T *) (((uint32_t)0x40000000) + 0xA0000))->COMCTL = (((DAC_T *) (((uint32_t)0x40000000) + 0xA0000))->COMCTL & ~(0xfful << (0))) | u32Delay;
}
...
void DAC_Close(DAC_T *dac, uint32_t u32Ch)
{
    if(u32Ch == 0)
    {
        ((DAC_T *) (((uint32_t)0x40000000) + 0xA0000))->CTL0 &= ~(0x1ul << (0));
    }
    else
    {
        ((DAC_T *) (((uint32_t)0x40000000) + 0xA0000))->CTL1 &= ~(0x1ul << (0));
    }
